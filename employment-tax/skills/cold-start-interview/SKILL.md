...
description: >
  ...
  template placeholders, or when the user says "set up payroll tax", "configure employment tax",
  "onboard me for payroll tax", or "get started with payroll tax". This is the only skill that should run on a fresh install.
